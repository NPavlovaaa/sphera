...
import {fetchCreateIncomeChange} from "../../api/userSlice";


const ModalWindowChangeIncomes = ({isShowModal, action, onShowModal}) => {
                    ...
                    <div className="relative py-3 w-2/5 lg:w-2/5 md:w-2/5 xl:w-1/3 2xl:w-1/3">
                        ...
                        <div className="relative bg-mainWhite shadow-lg sm:rounded-3xl px-20 py-16 rounded-3xl">
                            <div className="mx-auto">
                                ...
                                <div>
                                    {action === 'Consumption' ?
                                        <h1 className="text-2xl font-semibold">Добавление расхода</h1> :
                                        <h1 className="text-2xl font-semibold">Добавление дохода</h1>
                                    }
                                </div>
                                <Form method="POST">
                                    <div className="divide-y divide-gray-200">
                                        <div className="py-8 text-base leading-6 space-y-4 sm:text-lg sm:leading-7">
                                            ...
                                            <ErrorMessage component="div" style={{'color': 'red', 'margin-top': '1px', 'font-size' : '14px'}} name="note"/>
                                            <div className="relative">
                                                <Field
                                                    type="number"
                                                    name="price"
...
export default ModalWindowChangeIncomes;