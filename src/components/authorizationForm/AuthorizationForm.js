            ...
            >
                <div className="z-30 py-6 flex justify-center sm:py-12 sm:max-w-xl sm:mx-auto">
                    <div className="relative py-3 w-2/5 lg:w-2/5 md:w-2/5 xl:w-1/3 2xl:w-1/3 md:w-3/5">
                        <div
                            className="absolute inset-0 shadow-2xl rounded-3xl bg-gradient-to-r from-bgMainOrange-100 to-bgMainOrange-600 shadow-lg transform -rotate-6 sm:rounded-3xl">
                        </div>
                                    ...
                                    <div className="divide-y divide-gray-200">
                                        <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                            ...
                                            <div className="relative flex top-10 justify-center">
                                                <button type="submit" className="bg-bgMainOrange-600 text-white shadow-xl rounded-xl px-10 py-3">Войти</button>
                                            </div>
                                        </div>
                                    </div>
                                </Form>
